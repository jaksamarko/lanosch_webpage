          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="items-center justify-between overflow-hidden border lg:flex">
                <div className="w-full py-12 px-5 sm:px-12 md:p-16 lg:max-w-[580px] lg:py-9 lg:px-16 xl:max-w-[640px] xl:p-[70px]">
                  ...
                  <p className="mb-9 text-base leading-relaxed text-body-color">
                    Minden kör szeret minél többször kinyitni a félév során,
                    üdvözölni, szórakoztatni az egyetemistákat. Nálunk sincs ez
                    máshogy de talán kevesen tudják hogy majdnem annyi belsős
                    programot is rendezünk mivel mi igazán szeretünk leülni,
                    jófej emberekkel leülni egy játékhoz és persze{" "}
                    <s>iszogatni</s> beszélgetni.
                  </p>
                  <p className="mb-9 text-base leading-relaxed text-body-color">
